...
@Component({
  ...
  selector: 'prdproductsnotes',
  templateUrl: 'prdproductsnotes-list.component.html',
...
export class ProductNotesListComponent extends Paginated {
  //viewTemplateForm : NgForm;
  //@ViewChild('viewTemplateForm') currentForm: NgForm;
  //@ViewChild('childModal') public childModal: ModalDirective;
  Products: PrdProductNotes[];
  selectedProduct: PrdProductNotes;
  apiHost: string;
  ...
  constructor(
    private dataService: PrdProductNotesService,
  ...
  deleteProduct(Product: PrdProductNotes) {
    //console.log(domain);
        ...
        this.dataService.deleteProduct(Product.ProductId)
          .subscribe(rs => {
            if (rs.Succeeded) {
              ...
              this.itemsService.removeItemFromArray<PrdProductNotes>(this.Products, Product);
            }
            else {
  ...
  generateSource(product: PrdProductNotes) {
