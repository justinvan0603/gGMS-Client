...
@Component({
  ...
  selector: 'prdproductsnotes',
    templateUrl: 'prdproductsnotes-edit.component.html',
...
export class ProductNotesEditComponent implements AfterViewChecked    {
    ...
    public prdProductViewModel: PrdProductNotesViewModel;
  ...
  validationMessages = {
    ...
    constructor(
        ...
        private membershipService:MembershipService
            ...
            this.prdProductViewModel = new PrdProductNotesViewModel();
        }
            ...
            rs=>{
                if(rs.Succeeded)
                {
                    this.notificationService.printSuccessMessage(rs.Message);
                     this.router.navigate(['pages/prdproduct/productsnoteslist']);
                }
                else
                {
