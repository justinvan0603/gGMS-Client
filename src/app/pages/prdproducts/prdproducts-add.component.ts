...
@Component({
    ...
    templateUrl: 'prdproducts-add.component.html',
...
export class ProductAddComponent implements AfterViewChecked    {
  ...
  validationMessages = {
    ...
    constructor(
       ...
       public router: Router,
        ...
        private membershipService:MembershipService
            ...
            this.prdProductViewModel.ListSelectedCategory = new Array<TreeNode>();
    ...
    onlistSourceChecked(selectedSource: SourceModel,$event)
    {
        ...
        //alert("Caught!");
      this.prdProductViewModel.PrdProduct.Price = this.prdProductViewModel.PrdProduct.Price;
    }
    ...
    ngOnInit() {
        ...
        this.categoryService.setToken(this.membershipService.getTokenUser());
         this.prdProductViewModel.ListPlugins = new Array<PrdPlugin>(); 
         //this.loadPlugins();
         this.loadSources();
         this.loadTemplates();
    ...
    loadTemplateCode()
    {
        this.dataService.getProductCode().subscribe(
          (res:any)=>{
                this.prdProductViewModel.PrdProduct.ProductCode = res._body;
          }  ,
          error=>{
            this.loadingBarService.complete();
            if(error.status == 404)
    ...
    loadCategoryTree()
    {
        this.categoryService.getCategoryTree().subscribe(
          res =>{
              this.prdProductViewModel.ListCategory = res;
          } ,
          error =>{
            this.loadingBarService.complete();
            if(error.status == 404)
    ...
    loadSources()
    {
        this.sourceService.getAllSources().subscribe(
            res=>{
                this.prdProductViewModel.ListSources = res;
    ...
    loadTemplates()
    {
        this.templateService.getAllTemplates().subscribe(
                res=>{
                    this.prdProductViewModel.ListTemplates = res;
    ...
    loadPlugins()
    {
        this.pluginService.getAllPlugins('').subscribe(
            res=>{
                this.prdProductViewModel.ListPlugins = res;
...
ngAfterViewChecked(): void {
    ...
    addProduct()
    {
        ...
        this.dataService.createProduct(this.prdProductViewModel).subscribe(
            rs=>{
                if(rs.Succeeded)
                {
