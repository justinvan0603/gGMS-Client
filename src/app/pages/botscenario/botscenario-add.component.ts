...
@Component({
    ...
    templateUrl: 'botscenario-add.component.html',
...
export class BotScenarioAddComponent implements AfterViewChecked    {
...
ngAfterViewChecked(): void {
    ...
    addScenario()
    {
        ...
        this.dataService.createScenario(this.botScenarioViewModel).subscribe(
            rs=>{
                if(rs.Succeeded)
                {
