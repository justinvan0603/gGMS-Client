...
export class PrjProjectChartComponent implements AfterViewChecked {
  ...
  changeLanguage():void{
    ...
    $('#chart-container > div > div > div:nth-child(1) > div > svg > g:nth-child(3) > g:nth-child(2) > g > text').text('Số tiền');
    ...
    $('#productListPerformance > div > div > div:nth-child(1) > div > svg > g:nth-child(3) > g:nth-child(2) > rect:nth-child(1)').text('Số tiền');
    $('#productListPerformance > div > div > div:nth-child(1) > div > svg > g:nth-child(3) > g:nth-child(2) > g > text').text('Số tiền');
    ...
    $('#shoppingBehavior > div > div > div:nth-child(1) > div > svg > g:nth-child(3) > g:nth-child(2) > g > text').text('Số tiền');
